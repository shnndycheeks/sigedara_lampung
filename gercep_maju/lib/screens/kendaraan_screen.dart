...
// ── Konflik Kendaraan Banner ─────────────────────────────────────────────────
class _KonflikKendaraanBanner extends StatelessWidget {
  final Map<String, dynamic> konflik;
  final List<DateTime> alternatifHari;
  final void Function(DateTime hari) onPilihHari;

  const _KonflikKendaraanBanner({
    required this.konflik,
    required this.alternatifHari,
              ...
              child: Column(
                children: [
                  ...
                  _BannerRow(
                    icon: Icons.place_outlined,
                    label: 'Tujuan',
                    value: konflik['tujuan'] as String,
                  ),
                  const Divider(height: 12, color: AppColors.divider),
                  _BannerRow(
                    icon: Icons.date_range_outlined,
                    label: 'Tanggal',
                    value: '${konflik['berangkat']} – ${konflik['kembali']}',
                  ),
                ],
              ),
            ),
          ...
          if (alternatifHari.isNotEmpty) ...[
            ...
            Padding(
              ...
              child: Wrap(
                spacing: 8,
                runSpacing: 8,
                children: alternatifHari.map((hari) {
                  return GestureDetector(
                    onTap: () => onPilihHari(hari),
                    child: Container(
                      padding: const EdgeInsets.symmetric(
                        horizontal: 12,
                        vertical: 7,
            ...
            const Padding(
              ...
              child: Text(
                'Tidak ada tanggal tersedia dalam waktu dekat. Coba pilih tanggal lain.',
