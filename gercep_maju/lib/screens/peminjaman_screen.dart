            ...
            child: Column(
              ...
              children: [
                ...
                AnimatedSize(
                  ...
                  child: namaRuangan != null
                      ? Padding(
                          padding: const EdgeInsets.only(top: 14),
                          child: RuanganInfoCard(ruangan: namaRuangan),
                        )
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            RuanganInfoCard(ruangan: data['ruangan'] as String),
...
class RuanganInfoCard extends StatelessWidget {
  ...
  const RuanganInfoCard({super.key, required this.ruangan});
  ...
  Widget build(BuildContext context) {
    ...
    final String deskripsi = info['deskripsi'] as String;
    final String kapasitas = info['kapasitas'] as String;
    final List<String> fasilitas = (info['fasilitas'] as List<String>);
    final List<String> peraturan = (info['peraturan'] as List<String>);
    final String image = info['image'] as String;
